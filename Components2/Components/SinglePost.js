    ...
    return (
        <>
            <div style={{ margin: '0 20%' }} >
                <div style={{ backgroundColor: 'lightGreen' }}><center><h1>STORY</h1>
                    <h2>"Nothing Is Permanent"</h2>
                </center></div>
                <img alt='image' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSy5t0OlUWXW2LkmZBEI68Dtg9UCj0uk07-s61uScgSljH-axgcaitjc_okNqTopOvjfhk&usqp=CAU"
                    style={{ float: 'right', width: "30%", height: "350px", margin: '0 20px' }}
                />
                <div id="Translation">
                ...
                <div>
                    <p>
                        <textArea type='text' name='CommentBox' id='CmdBox' placeHolder='Comment your Thoughts...' style={{ width: '100%', height: '50px', fontSize: '20px' }}></textArea>
                    </p>
                    <p>
                        <center><button type="button" style={{ margin: '0px', width: '10%', height: '40px', textAlign: 'center', borderRadius: '10px', border: '2px solid ' }}>Post</button></center>
                    </p>
                </div>
            </div>
        </>
